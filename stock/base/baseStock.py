        ...
        if (code == 603933):
            ...
            stock_data.to_csv(con.csvPath + codeStr + '.csv', index=False,
                              columns=['date', 'code', 'open', 'close', 'high', 'low', 'volume', 'day1o/day0c',
                                       ...
                                       'day5highIncome', 'day5closeIncome', 'day6highIncome', 'day6closeIncome', '5days','10days','20days',
                                       '30days', '60days','80days', '90days','1000days', '120days',
...
def update_today_stock():
    # 获取今日数据
    stock_data = ts.get_today_all()
    stock_data.to_csv(con.basePath + 'today.csv', encoding='gbk')
